...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Tools to support the automation of daily manga-related activities.}
  spec.description   = %q{Tools to support the automation of daily manga-related activities.}
